...
Event.when('SteamBots.tradeRequestAccepted', 'SteamBots.tradeRequestAccepted')
Event.when('SteamBots.tradeError', 'SteamBots.tradeError')
Event.when('SteamBots.countInventory', 'SteamBots.countInventory')
